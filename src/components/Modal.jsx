...
const Modal = () => {
  ...
  const { movieTrailerModal, videoKey, movie } = useSelector(
    (state) => state.modal
  );
  ...
  return (
    <div className={`movie-modal ${movieTrailerModal ? "open" : ""}`}>
      ...
      <div className="actions">
        <button className="watch-later" onClick={handleAddWatchLater}>
          Watch Later
        </button>
        <button className="add-favourites" onClick={handleAddFavourites}>
